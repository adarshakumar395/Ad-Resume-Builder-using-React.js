      ...
      const workExpBody = (
        <div className= {styles.detail}>
                <div className = {styles.row}>
                    <InputControl 
                        label ="Title" 
                        placeholder = "Enter company name eg. Frontend Developer"
            ...
            <div className={styles.detail}>
                <div classname = {styles.row}>
                    <InputControl 
                        label = "Title" 
                        defaultValue = {values.title} 
                        placeholder = "Enter tilte eg. Chat application"
                        onChange = {(event)=>
                            setValues((prev) => ({...prev, title: event.target.value}))
                        }
            ...
            <div className={styles.detail}>
                <div className = {styles.row}>
                     <InputControl 
                        label = "Title"
                        defaultValue = {values.title}
                        palceholder= "Enter title eg. B-Tech"
                        onChange = {(event)=>
                            setValues((prev) => ({...prev, title: event.target.value}))
                        }
                     />
                     <InputControl
                        ...
                        palceholder= "Enter name of the College/School"
                        onChange = {(event)=>
                     ...
                     <div className={styles.row}>
                        ...
                        label="Start Date"
                        type ="date"
                        placeholder =" Enter start date of this eductaion"
                        defaultValue = {values.startDate}
                        onChange = {(event)=>
                            setValues((prev) => ({...prev, startDate: event.target.value}))
                        }
                        ...
                        label="End Date"
                        type ="date"
                        placeholder =" Enter end date of this eductaion"
                        defaultValue = {values.endtDate}
                        onChange = {(event)=>
                            setValues((prev) => ({...prev, endDate: event.target.value}))
                        }
                        />
        ...
        const basicInfoBody = (
            <div className={styles.detail}>
                <div className={styles.row}>
                    <InputControl
                        label = "Name"
                        placeholder = "Enter your full name eg. xyz"
                ...
                <div className={styles.row}>
                    <InputControl
                        ...
                        placeholder = "Enter your email eg. @gmail.com"
                        onChange = {(event)=>
